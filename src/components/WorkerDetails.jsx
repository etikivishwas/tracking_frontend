...
const gatewayCoords = {
  ...
  "GW_G_ZONE_G": { lat: 15.58675, lon: 79.82731, label: "A1" },
  "GW_B_ZONE_B": { lat: 15.58625, lon: 79.82715, label: "A2" },
  'GW_E_ZONE_E': {lat: 15.58626, lon: 79.82732, label: "A3" },
  'GW_A_ENTRANCE': {lat: 15.58674, lon: 79.82786, label: "A4" },
}
const bounds = [
